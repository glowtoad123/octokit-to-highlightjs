...
var _oth_instances, _oth_codeIndex, _oth_findAndHighlight;
    ...
    replaceWithHighlighted() {
        ...
        if (hljsClassAdder.includes('class="pl-')) {
            ...
            while (__classPrivateFieldGet(this, _oth_codeIndex, "f") <= this.listOfCode.length) {
                hljsClassAdder[__classPrivateFieldGet(this, _oth_codeIndex, "f") + tracker] = this.listOfCode[__classPrivateFieldGet(this, _oth_codeIndex, "f")];
...
_oth_codeIndex = new WeakMap(), _oth_instances = new WeakSet(), _oth_findAndHighlight = function _oth_findAndHighlight() {
